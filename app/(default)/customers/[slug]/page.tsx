...
export default async function CustomerSingle({ params }) {
  ...
  return (
    <section className="relative">
      ...
      {/* Illustration */}
      <div
        className="absolute -mt-16 -translate-x-1/2 pointer-events-none md:block left-1/2 blur-2xl opacity-90 -z-10"
        aria-hidden="true"
      >
        <Image
          src={Illustration}
            ...
            <div className="pb-12 md:grow md:pb-20">
              <div className="max-w-3xl">
                <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
                  ...
                  <header>
                    <h1 className="inline-flex pb-4 text-transparent h2 bg-clip-text bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60">
                      {content.title}
                    </h1>
                    <div className="flex items-center mb-8 space-x-4 text-sm">
                      <img
            ...
            <aside className="md:w-64 lg:w-80 md:shrink-0 md:pt-[3.75rem] lg:pt-0 pb-12 md:pb-20">
              <div className="sticky top-6 md:pl-6 lg:pl-10">
                ...
                <div className="space-y-6">
                  {/* Widget */}
                  <div className="border bg-gradient-to-tr from-slate-800 to-slate-800/25 rounded-3xl border-slate-800">
