    ...
    <>
      <div className="stellar-carousel swiper-container group">
        <div className="swiper-wrapper w-fit">
          {/* Carousel items */}
          <div className="relative h-auto transition-colors border swiper-slide bg-gradient-to-tr from-slate-800 to-slate-800/25 rounded-3xl border-slate-800 hover:border-slate-700/60 group">
            <div className="flex flex-col h-full p-5">
              <div className="flex items-center mb-3 space-x-3">
                ...
                <Link
                  className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 group-hover:before:absolute group-hover:before:inset-0"
              ...
              <div className="flex justify-between">
                <div className="flex -space-x-3 -ml-0.5">
                  <Image
                    className="box-content border-2 rounded-full border-slate-800"
                    src={Avatar01}
                    width={24}
                    height={24}
                    alt="Avatar 01"
                ...
                <button className="flex items-center space-x-2 text-sm font-medium transition-colors text-slate-300 hover:text-white">
